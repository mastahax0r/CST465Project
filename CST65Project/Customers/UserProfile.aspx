    ...
    <asp:MultiView ID="multiView1" ActiveViewIndex="0" runat="server">
        <asp:View ID="view1" runat="server">
            ...
            <asp:DropDownList ID="uxState" runat="server">
                ...
                <asp:ListItem Value=""></asp:ListItem> <%--//Added to fix problem with new users sho dont have a state yet.--%>
            </asp:DropDownList>
            <br />
            ...
            <asp:Label ID="UxDeletePicCBLabel" CssClass="rightAlign" AssociatedControlID="uxDeletePicCB" runat="server"> Delete Avatar: </asp:Label>
            <asp:CheckBox ID="uxDeletePicCB" runat="server" />
            <br />
            ...
            <asp:Image ID="uxImageCopy" runat="server" />
        </asp:View>

        <asp:View ID="view2" runat="server">
            <strong class="rightAlign">First Name:</strong><asp:Literal ID="uxFirstNameResult" Text="" runat="server"></asp:Literal><br />
            <strong class="rightAlign">Last Name:</strong><asp:Literal ID="uxLastNameResult" Text="" runat="server"></asp:Literal><br />
            <strong class="rightAlign">Age:</strong><asp:Literal ID="uxAgeResult" Text="" runat="server"></asp:Literal><br />
            <strong class="rightAlign">Phone Number:</strong><asp:Literal ID="uxPhoneNumberResult" Text="" runat="server"></asp:Literal><br />
            <strong class="rightAlign">Email:</strong><asp:Literal ID="uxEamilResult" Text="" runat="server"></asp:Literal><br />
            <strong class="rightAlign">Street:</strong><asp:Literal ID="uxStreetResult" Text="" runat="server"></asp:Literal><br />
            <strong class="rightAlign">City:</strong><asp:Literal ID="uxCityResult" Text="" runat="server"></asp:Literal><br />
            <strong class="rightAlign">State:</strong><asp:Literal ID="uxStateResult" Text="" runat="server"></asp:Literal><br />
            <strong class="rightAlign">Zip:</strong><asp:Literal ID="uxZipResult" Text="" runat="server"></asp:Literal><br />
            <br />
            <asp:Image ID="uxImage" runat="server" />
            <br />
            <asp:Button ID="uxEditButton" Text="edit profile" OnClick="uxEditButton_Click" runat="server" />
        </asp:View>
    </asp:MultiView>
